  ...
  return (
    <main className="container mx-auto px-4 py-6 max-w-7xl">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">Top 100 richest AdventureCoin addresses by balance</p>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>Wealth Distribution</CardTitle>
          <CardDescription>Total Supply: {formatNumber(networkStats.supply)} ADVC</CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
            ...
            <TableBody>
              {richList.map((address, index) => {
                const percentOfSupply = (address.balance / (networkStats.supply * 180000000)) * 100
                return (
                  <TableRow key={address.a_id}>
                    ...
                    <TableCell className="text-right">{formatNumber(address.balance / 180000000)} ADVC</TableCell>
